...
//logger("RESPONSE RETURN FROM JOURNAL VOUCHER ENTRY: ".$response);
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input name="voucherDate" type="text" class="form-control" id="voucherDate" value="<?php echo date('d-m-Y'); ?>" readonly="">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Voucher Date<span class="mandat">*</span></label>
                    <input name="entryDate" type="text" class="form-control newDatePicker" id="entryDate" readonly="" required>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <table width="100%" border="1" cellpadding="5" cellspacing="0" class="table" style="font-size: 12px !important; width: 100%; border: 1px solid #ccc !important;">
                    <tr style="padding: 10px; font-size: 13px; font-weight: 600; background-color: #F8F8F8; margin-top: 0; position: relative;">
                      ...
                      <?php for($w=1;$w<=5;$w++){?>
                        ...
                        <td><input type="number" name="credit[]" onblur="funcSumValue();" onkeyup="funcCreditEnable(<?php echo $w; ?>);" id="credit_<?php echo $w; ?>" class="creditsum form-control" value="0" ></td>

                        <td><input type="text"  name="narration[]" id="narration_<?php echo $w; ?>" class="form-control"></td>
                  ...
                  <div style="margin-top:20px; width:100%; display:block; text-align:right;">
                    <button name="addbranchinfo" type="submit" class="btn btn-primary" id="btnsubmit" style="margin:0px; width:100px;display:none;">Save<i class="fa fa-floppy-o ml-2" aria-hidden="true" style="margin:0px;"></i></button>
                  </div>
                </div>
              </div>
            </div>
...
<script>
        ...
        $(document).ready(function () {
            $(".add-row").click(function () {
				...
				$no=1;
				foreach($accountData->AccountNameData as $resultList){
				?><option value='<?php echo $resultList->AccountCode; ?>'><?php echo $resultList->AccountName; ?> [<?php echo $resultList->AccountCode; ?>]</option><?php } } } ?></select></td><td><input type='number' name='debit[]' onkeyup='funcDebitEnable("+rowno+");' onBlur='funcSumValue();' id='debit_"+rowno+"' class='debitsum form-control'  value='0'></td><td><input type='number' name='credit[]' onkeyup='funcCreditEnable("+rowno+");' onBlur='funcSumValue();' id='credit_"+rowno+"' class='creditsum form-control' value='0' ></td><td><input type='text' name='narration[]' id='narration_"+rowno+"' class='form-control'></td></tr>";
