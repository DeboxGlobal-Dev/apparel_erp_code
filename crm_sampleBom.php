...
<tr role="row" class="odd">
	<td><a href="showpage.crm?module=<?php echo $_GET['module']; ?>&edit=yes&id=<?php echo encode($resultlists['id']); ?>"><?php // if($sampleFor==100){ echo 'Self'; }else{ echo 'Buyer Inspiration'; }  ?><?php echo '#'.getStyleRefId($styleId); ?></a></td>
