...
$rrrr=GetPageRecord('*','randdMaster','styleId="'.$resultlists['id'].'"');
...
?>
						 ...
						 <td><?php echo date('d-M-Y',strtotime($resultlists['pcdDate'])); ?></td>
                         <td><!--<span class="badge badge-flat" style="border:1.5px solid <?php echo $result1['statusColor']; ?>; background-color:#fff; color:black; position: relative; width: 142px; font-size: 11px; padding: 6px;"> <?php echo $result1['name']; ?></span> --><?php if($resultOperation['techFinal']=='1'){ ?><span class="badge" style="background-color:#0288d1; color:#FFFFFF; position: relative; width: fit-content;">Work-In Progress</span><?php }if($resultOperation['techFinal']=='2'){ ?><span class="badge" style="background-color:#33cc33; color:#FFFFFF; position: relative; width: fit-content;">Complete</span><?php }?></td>
                        <td>

						<div style="width:200px;">

						<a href="download-randd.php?styleid=<?php echo encode($resultlists['id']); ?>" target="_blank" style="background: #0288d1; outline: none; color: #fff; padding: 5px; border-radius: 2px; cursor: pointer; width: 95px; display: block; float:left;  text-align:center;"><i class="fa fa-download" aria-hidden="true"></i> Excel</a>
						<a href="tcpdf/examples/generaterd.php?pageurl=<?php echo $fullurl; ?>rdpdf.php?styleid=<?php echo encode($resultlists['id']); ?>" target="_blank" style="background: #e71c22; outline: none; color: #fff; padding: 5px; border-radius: 2px; cursor: pointer; width: 95px; display: block; float:right; margin-left:5px; text-align:center;"><i class="fa fa-download" aria-hidden="true"></i> PDF</a>
						</div>
