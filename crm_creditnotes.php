              ...
              <div class="col-md-12">
                <form name="listform" id="listform" method="get">
                  ...
                  <table class="table" width="100%">
                    ...
                    <td colspan="4"><div style="text-transform:capitalize;color:white;font-size: 15px;">Supplier Credit Note</div></td>
                     </tr>
					...
					<tr style="padding: 10px; font-size: 13px; font-weight: 600; background-color: #F8F8F8; margin-top: 0; position: relative;">
                      ...
                      <td align="center"><div style="text-transform:capitalize;"><input type="text" class="erpint" name="suppliercred" id=""></div></td>
                      <td align="center"><div style="text-transform:capitalize;">Date</div></td>
                      <td align="center"><div style="text-transform:capitalize;"><input type="date" class="erpint" name="creditdate" id=""></div></td>
                    </tr>
                  </table>
               ...
               <table class="table erptab" width="100%">
                    ...
                    <tr style="background: #0288d1;">
                         <td colspan="5"><div style="text-transform:capitalize;color:white;font-size: 15px;">Credit Note Info
                         </div>
                         </td>
                     </tr>
                     <tr>
                         ...
                         <td>
                             <select style="width:75%;" class="erpint" name="credittype" id="">
                                 <option value="gmpo">Against GMPO</option>
                             </select>
                         </td>
                         <td><div style="text-transform:capitalize;"><b>Reason</b></div></td>
                         <td>
                             <select style="width:50%;" class="erpint" name="reasoncred" id="">
                         ...
                         <td style="width:25%"></td>
                                          ...
                                          <tr>
                         <td><div style="text-transform:capitalize"><b>Credit Note No.</b></div></td>
                         <td><input style="width:75%;" type="text" class="erpint" name="creditnumber" id=""></td>
                         <td><div style="text-transform:capitalize;"><b>Total CN Amount</b></div></td>
                         <td>
                             <input style="width:10%;" class="erpint" name="cnamountpercent" id=""> % OR
                             <input style="width:21%;" class="erpint" name="cnamount" id="">
                     ...
                     <tr>
                         ...
                         <td><div style="text-transform:capitalize"><b>Supplier Bank</b></div></td>
                         <td>
                              <select style="width:75%;" class="erpint" name="supplierbank" id="">
                                 <option value="">Select</option>
                             </select>
                        </td>
                        <td><div style="text-transform:capitalize;"><b>Payment Term</b></div></td>
                         <td>
                             <select style="width:50%;" class="erpint" name="paymenttermcred" id="">
                                 <option value="">Select</option>
                             </select>
                         </td>
                         <td></td>
               ...
               <!--<div style="height:383px;overflow-y:scroll">-->
			      <table class="table table-hover no-footer apparelclass" width="100%">
					...
					<tr style="padding: 10px; font-size: 13px; font-weight: 600; background-color: #eefafd; margin-top: 0; position: relative;">
					 ...
					 <tr style="background: #0288d1;">
                         <td colspan="14" style="padding:10px"><div style="text-transform:capitalize;color:white;font-size: 15px;">Supplier Credit Notes
					...
					<tr style="padding: 10px; font-size: 13px; font-weight: 600; background-color: #F8F8F8; margin-top: 0; position: relative;">
					  ...
					  <td align="center"><div style="text-transform:capitalize;">Supplier</div></td>
					  <td align="center"><div style="text-transform:capitalize;">Credit Note Type</div></td>
					  <td align="center"><div style="text-transform:capitalize;">Credit Note No.</div></td>
