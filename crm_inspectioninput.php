...
$queryDataq=GetPageRecord('id,subject','queryMaster','1 and id="'.$resultlists['styleId'].'"');
...
?>
                          ...
                          <td><?php echo date('d-m-Y',strtotime($resultlists['dateField'])); ?></td>
                          ...
                          <td align="center"><?php if($editpermission==1){ ?>
                            <div class="btn-class"> <a href="showpage.crm?module=<?php echo $_GET['module']; ?>&add=yes&id=<?php echo encode($resultlists['id']); ?>" class="btn btn-warning" style="padding:7px; margin:0px;"><i class="fa fa-pencil " aria-hidden="true" style=" color: #fffffff1; font-size: 16px; "></i></a> </div>
                            <?php } ?>                          </td>

                            <td>
						    <div>

						<a href="download-inspectioninput.php?styleId=<?php echo encode($resultlists['id']); ?>"
						target="_blank"
