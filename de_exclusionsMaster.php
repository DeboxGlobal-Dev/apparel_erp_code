...
<div class="page-content">
 ...
 <a href="#" onclick="opmodalpop(' Add Exclusions','modalpop.php?action=exclusions','600px','auto');"  data-toggle="modal" data-target="#modalpop" class="btn bg-teal-400"  aria-expanded="false"  style="    background-color: #03d873b8;"><i class="fa fa-plus" aria-hidden="true"></i> Create New</a>
...
$rs=GetRecordList($select,'exclusionsMaster',$where,$limit,$page,$targetpage);
$totalentry=$rs[1];
$paging=$rs[2];
...
?>
						...
						<tr role="row" class="odd">
								<td width="60%" align="left" class="sorting_1"><a   title="<?php echo $resultlists['name']; ?>" style=" color:#2196f3; display:block; min-width:120px; " href="#"  onclick="opmodalpop(' Edit Exclusions','modalpop.php?action=exclusions&id=<?php echo encode($resultlists['id']); ?>','600px','auto');"  class="shorttextcard" data-toggle="modal" data-target="#modalpop"  ><?php echo strip($resultlists['name']); ?></a> </td>
