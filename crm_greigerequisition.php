      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="card-header header-elements-inline bg-blue-700 filterable" style="padding: 10px;">
            ...
            <!--  <div class="btn-group justify-content-center" style="float:right;"> <a href="showpage.crm?module=<?php echo $_GET['module']; ?>&add=yes" class="btn bg-teal-400 addnotify" aria-expanded="false" style="    background-color: #03d873b8;"><i class="fa fa-plus" aria-hidden="true"></i> Create New</a> </div>-->
            <!--</div>-->
          </div>
          <div class="card">
            ...
            <div class="card-body">
              <ul class="nav nav-tabs nav-tabs-highlight nav-justified">
                ...
                <li class="nav-item"><a href="#highlighted-justified-tab2" class="nav-link" data-toggle="tab"><strong>Yarn Requisition</strong></a></li>
              </ul>
...
?>
                        ...
                        <td><a href="showpage.crm?module=<?php echo $_GET['module']; ?>&add=yes&id=<?php echo encode($resultlists['id']); ?>"><?php echo $resultlists['requisitionNo']; ?></a></td>
                        ...
                        <td><?php if($resultlists['status']==0){ echo '-'; }else{ echo getUserName($resultlists['addedBy']);} ?></td>
                        <td>	<a href="tcpdf/examples/generategreigerequisition.php?pageurl=<?php echo $fullurl; ?>download-greigerequisition.php?id=<?php echo encode($resultlists['id']); ?>" target="_blank" style="background: #e71c22; outline: none; color: #fff; padding: 5px; border-radius: 2px; cursor: pointer; width: 95px; display: block;">
        ...
        <div class="col-xl-8">
                                 ...
                                 <div id="DataTables_Table_2_filter" class="dataTables_filter" style="visibility:hidden;">
              <div class="row specialclass">
                 <form action="" method="get">
                  <div class="col-md-12" style="padding:0px;">
                     <label>
             ...
             <div class="col-xl-4" style="padding-right: 0px;">
              <div class="btn-group justify-content-center" style="float:right;"> <a href="showpage.crm?module=yarnrequisition&add=yes" class="btn bg-teal-400 addnotify" aria-expanded="false" style="    background-color: #03d873b8;"><i class="fa fa-plus" aria-hidden="true"></i> Create New</a> </div>
            </div>
...
?>
                        <tr role="row" class="odd">
                        <td><a href="showpage.crm?module=yarnrequisition&add=yes&id=<?php echo encode($resultlists['id']); ?>"><?php echo $resultlists['requisitionNo']; ?></a></td>
                        <td><?php echo date('d-M-y', strtotime($resultlists['requisitionDate'])); ?></td>
                        <td><?php echo $resultlists['styleNo']; ?></td>
                        <td><?php echo $brandData['name']; ?></td>
                        <td><?php echo getSeasonName($resultlists['seasonId']); ?></td>
