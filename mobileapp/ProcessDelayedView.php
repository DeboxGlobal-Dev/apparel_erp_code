      ...
      public $ResponsiblePerson;
        ...
        $rs1=GetPageRecord('*','timeActionReport','1 and responsiblity="'.$ids.'" and actualDate="1970-01-01" and  complitionDate<="'.date('Y-m-d').'" and taskListId in (select id from taskListMaster where tna=1) and responsiblity!=""   order by complitionDate asc');
