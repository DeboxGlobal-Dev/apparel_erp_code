                ...
                <div class="row">
				  ...
				  <table width="100%" border="1" cellspacing="2" cellpadding="8" style="border:1px solid #ccc;">
					  ...
					  <thead style="background: #ffffed;">
						...
						<?php
						$no = 1;
						$whC = '1 and styleId="'.decode($_GET['styleid']).'" and sectionType="'.$_GET['module'].'" order by id desc';
					$rsC=GetPageRecord('*','techpackPatternMarkerUpload',$whC);
						while($result1=mysqli_fetch_array($rsC)){
						?>
					   <tr>
