...
?>
                      ...
                      <tr>
                          ...
                          <td style="padding-left:20px;"><?php echo $count;?></td>
        <td style="padding-left:20px;"><?php echo str_replace('%','+',$rsListData['grade']); ?></td>
        <td style="padding-left:20px;"><?php echo $rsListData['attachment']; ?></td>
        <td style="padding-left:20px;"><?php echo $rsListData['allocateMc']; ?></td>
   ...
   <td><?php echo $critical['name'] ?></td>
	...
	?>
        ...
        <td style="padding-left:20px;"><?php echo $rsListData['allocateMcb']; ?></td>
        <td style="padding-left:20px;"><?php echo $rsListData['attachmentb']; ?></td>
        <td style="padding-left:20px;"><?php echo str_replace('%','+',$rsListData['gradeb']); ?></td>
