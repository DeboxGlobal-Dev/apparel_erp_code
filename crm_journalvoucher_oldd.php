              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div style="margin-top:20px; width:100%; display:block; text-align:right;">
                    <button name="Submit1" type="submit" class="btn btn-primary" style="margin:0px; width:100px;">Save<i class="fa fa-floppy-o ml-2" aria-hidden="true" style="margin:0px;" onclick="saveALL();"></i></button>
                  </div>
                </div>
              </div>
            </div>
