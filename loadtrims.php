...
<tr id="trimsid<?php echo $id; ?>">
<td align="center" id="">&nbsp;</i></td>	
<td><i class="icon-trash" style="font-size:20px;cursor:pointer;" onclick="removetrims(<?php echo $id; ?>);"></i></td>
...
<script>
function removetrims(id){
	$('#trimsid'+id).remove();
	var contactpCounttrims = $('#contactpCounttrims').val();
	contactpCounttrims=Number(contactpCounttrims)-1;  
	$('#contactpCounttrims').val(contactpCounttrims);
}
</script>
