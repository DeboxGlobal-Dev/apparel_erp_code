...
deleteRecord('transferMaster',$where);

$dateAdded=time();
$namevalue ='name="",updateBy='.$_SESSION['userid'].',updateDate='.$dateAdded.'';
$lastId = addlistinggetlastid('transferMaster',$namevalue);
}
			...
			<div class="content">
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					...
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-1" style="cursor:pointer;"  <?php if($_REQUEST['id']!=''){ ?> onclick="view('<?php echo $_REQUEST['id']; ?>');" <?php } else { ?> onclick="cancel();"<?php  } ?> ></i> 	<?php if($_REQUEST['id']!=''){ echo 'Edit'; } else { echo 'Add'; } ?> Transfer </h4>
...
$rs='';
$select='*';
$where=' 1 and categoryType="transfer" order by id asc';
...
$rs='';
$select='*';
$where=' 1 and sectionType="transfer" order by id asc';
...
<input name="editId" type="hidden" id="editId" value="<?php echo encode($lastId); ?>" /><?php
		...
		<input name="action" type="hidden" id="action" value="edittransfer" />
