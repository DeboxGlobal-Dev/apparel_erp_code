...
?>
							...
							<td align="center"><?php echo $resultlists['displayId']; ?></td>
								...
								<td><a href="showpage.crm?module=lineallotmentplan&add=yes&styleid=<?php echo encode($resultlists['id']); ?>"><?php echo '#'.$resultlists['styleRefId']; ?><?php if(countQueryunreadMails($resultlists['id'])!=0){ ?><div class="numberbubbol"><?php echo countQueryunreadMails($resultlists['id']); ?></div><?php } ?></a></td>
