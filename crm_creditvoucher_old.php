...
deleteRecord('accountsMaster','module="'.$_GET['module'].'" and addedBy="'.$_SESSION['userid'].'" and creditaccounthead=0');
deleteRecord('debitvoucherMaster','addedBy="'.$_SESSION['userid'].'" and accountHeadId=0');

$where='1 and module="'.$_GET['module'].'" and creditaccounthead!=0 order by id desc';
$rs=GetPageRecord('*','accountsMaster',$where);
$accountData=mysqli_fetch_array($rs);

$autiid = explode('-',$accountData['displayId']);
$autoId = $autiid[1]+1;
$finalDisplayId='CV-000'.$autoId;
  ...
  <div class="content pt-0" style="margin-top: 20px; width: 100%; margin-left: auto; margin-right: auto;">
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="creditaccounthead" id="creditaccounthead">
    ...
    "GroupId":'.$GroupId.'
        ...
        foreach($accountData->AccountData as $resultList){
          ?>
          <option value="<?php echo $resultList->Id; ?>" <?php if($resultList->Id == $resListing1['creditaccounthead']){ ?> selected="selected" <?php } ?>><?php echo $resultList->AccountName; ?></option>
          <?php } } } ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <table width="100%" border="1" cellpadding="5" cellspacing="0" class="table" style="font-size: 12px !important; width: 100%; border: 1px solid #ccc !important;">
                    <tr style="padding: 10px; font-size: 13px; font-weight: 600; background-color: #F8F8F8; margin-top: 0; position: relative;">
                      ...
                      <td align="center"><div align="center">Amount</div></td>
                    </tr>
                    <tbody id="addrow">
                    </tbody>
                    <script>
            ...
            <div class="row">
              <div class="col-md-12">
                <table width="100%" border="1" cellpadding="5" cellspacing="0" class="table" style="font-size: 12px !important; width: 100%; border: 1px solid #ccc !important;">
                  ...
                  <?php
				   $sNo=0;
									$rs=GetPageRecord('*','accountsMaster','1 and creditaccounthead!=0 and module="'.$_GET['module'].'" order by dateAdded desc');
                  ...
                  <tr>
                    ...
                    <td align="center"><div align="left"></div></td>
                    <td align="center"><div align="left"> </div></td>
                    <td align="center"><div align="left"><?php echo $subVoucherAppData['amount']; ?> </div></td>
                    <td align="center"><div align="left"></div></td>
                  </tr>
                  <?php } } ?>
                </table>
