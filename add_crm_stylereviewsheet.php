			...
			<div class="content pt-0" style="margin-top:20px;">
			    <div class="col-xl-12" style="padding:0px;">
				 <div class="card">
							...
							<div class="card-body" style="text-align: center; background-color: #e1f1ff;">
                                <td width="100%" style="text-align:center;"><strong style="font-size: 16px; font-weight: 500;">Pre-Production</strong></td>
...
?>
									...
									<td style="background-color: #f5f5f5;"><?php if($data['complitionDate']!='' && $data['complitionDate']!='1970-01-01' && $data['complitionDate']!='0000-00-00'){ echo date('d-m-Y', strtotime($data['complitionDate'])); } ?></td>
...
<?php  }  ?>
 ...
 <div id="add_indentmpl" style="padding:18px;">

							<div class="card-body" style="text-align: center; background-color: #e1f1ff;">
                                <td width="100%" style="text-align:center;"><strong style="font-size: 16px; font-weight: 500;">Fabric Status</strong></td>
...
<div class="card-body" style="text-align: center; background-color: #e1f1ff;">
<td width="100%" style="text-align:center;"><strong style="font-size: 16px; font-weight: 500;">Trim Status</strong></td>
	...
	<div class="page-content">
	 ...
	 <div class="content-wrapper">
		  ...
		  <div class="content pt-0" style="margin-top:20px;">
				...
				<div class="card">
				    <div class="card-body" style="text-align: center; background-color: #e1f1ff;">
                                <td width="100%" style="text-align:center;"><strong style="font-size: 16px; font-weight: 500;">PO&nbsp;&&nbsp;CD&nbsp;Summary</strong></td>
