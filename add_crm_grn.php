                          ...
                          <td><table width="100%" border="1" cellspacing="0" cellpadding="5" class="table1" style="border: 1px solid #868686;">
                              <tr>
								...
								<div class="form-group">
									...
									<br />
									<?php
									$rsindentcreation=GetPageRecord('shipTo','indentCreationMaster','poNumber="'.$editresultgate['ponumber'].'"');
									$rsindentcreationdata=mysqli_fetch_array($rsindentcreation);
									$exploadShipTo = explode('~',$rsindentcreationdata['shipTo']);
									if($exploadShipTo[0]=='F'){
										$factAddrs=GetPageRecord('name','factoryMaster','id="'.$exploadShipTo[1].'"');
										$factAddrsData=mysqli_fetch_array($factAddrs);
									?>
									<div style="background-color: #f1f1f1; padding: 15px; margin-top: 8px; border: 1px solid #ccc; height:137px;">
									<strong><?php echo $factAddrsData['name']; ?></strong>
									</div>
									<?php
									}else{
										$vendorRs=GetPageRecord('name','vendorMaster','id="'.$exploadShipTo[1].'"');
										$vendorRsData=mysqli_fetch_array($vendorRs);

										$venAddrs=GetPageRecord('*',_ADDRESS_MASTER_,'1 and addressParent="'.$exploadShipTo[1].'" and addresstype="vendors"');
										$venAddrsData=mysqli_fetch_array($venAddrs);
									?>
									 <div style="background-color: #f1f1f1; padding: 15px; margin-top: 8px; border: 1px solid #ccc; height:137px;">
									 <strong><?php echo $vendorRsData['name']; ?></strong>
									 <br />
									 <?php echo $venAddrsData['address']; ?>
	...
	$(".select2").select2();
								...
								<tr>
								 ...
								 <tr>
                                      ...
                                      <td><input type="text" name="supplierPurchaseOrderId" value="<?php echo $editresultgate['ponumber']; ?>" class="form-control" readonly="" /></td>
                                    </tr>
                                    <!--<tr>
                                      <td>GRN.&nbsp;No:</td>
								...
								$("#eWayBillDate").datepicker();
                                    ...
                                    <tr>
                                     ...
                                     <!--<td><input type="text" name="docNo" id="docNo" class="form-control" value="<?php  echo $editresult['docNo']; ?>"/></td>-->
                                      ...
                                      <td><input type="text" name="docNo" id="docNo" class="form-control" readonly="readonly" value="<?php  echo $editresultgate['challanno']; ?>"/></td>
                                    </tr>
                                    <!--<tr>
                                    <td>QC&nbsp;Status: </td>
                                    ...
                                    <tr>
                                      <td>E-Way&nbsp;Bill&nbsp;No: </td>
                                      <td><input type="text" name="eWayBill" id="eWayBill" class="form-control"  readonly="readonly" value="<?php echo $editresultgate['ewaybill']; ?>" /></td>
                                    </tr>
                                    <tr>
                                      <td>Party&nbsp;Bill&nbsp;No:</td>
                                   ...
                                   <!--<td><input type="text" name="qcStatus" id="qcStatus" class="form-control" value="<?php  echo $editresult['qcStatus']; ?>"/></td>-->
                                      ...
                                      <td><input type="text" name="qcStatus" id="qcStatus" class="form-control" readonly="readonly" value="<?php  echo $editresultgate['partybill']; ?>"/></td>
                                    </tr>
                                    <!-- <tr>
                        ...
                        <tr>
                          <td>
                              <table width="100%" border="1" cellpadding="10" cellspacing="0" bordercolor="#000000" class="">
								...
								// 	$('#loadtabledata').load('loadgrn.php?action=addnewrow&addsize='+did+'&id='+lastid+'&geteEntryid='+gateEntryNo);
							$('#loadtabledata').load('loadgrn.php?action=addnewrow&addsize='+did+'&id='+lastid+'&geteEntryid='+gateEntryNo+'&poid=<?php echo $editresultgate['ponumber']; ?>');
