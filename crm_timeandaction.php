...
?>
                      <tr>
					   <td><a href="showpage.crm?module=<?php echo $_GET['module']; ?>&add=yes&styleid=<?php echo encode($resultlists['id']); ?>"><?php echo '#'.$resultlists['styleRefId']; ?>
					    ...
					    <a href="download-tna.php?styleId=<?php echo encode($resultlists['id']); ?>"
						 target="_blank"
						...
						<a href="<?php echo $fullurl; ?>tcpdf/examples/generatetnasheet.php?pageurl=<?php echo $fullurl; ?>
						printtnasheet.php?id=<?php echo encode($resultlists['id']); ?>" target="_blank"
						style="background: #e71c22; outline: none; color: #fff; padding: 5px; border-radius: 2px;
						cursor: pointer; width: 95px; display: block; float:right; margin-left:5px;"><i class="fa fa-print" aria-hidden="true">
						    </i>TNA</a> </div></td>
