...
$where='id='.$id.'';
$rs=GetPageRecord($select,'companyMaster',$where);
				...
				<!--Middle Section-->
				 ...
				 <div class="card">
							...
							<div class="media">
									...
									<h6 class="media-title font-weight-semibold">Company Details</h6>
									</div>
...
<!--<li class="nav-item"><a href="#solid-rounded-justified-tab4" class="nav-link rounded-left" data-toggle="tab">Style&nbsp;Information</a></li>-->
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<select name="buyerType" id="buyerType" class="form-control">
									<option value="1" <?php if($resultpage['companyType']==1){ echo "selected"; }?>>Foreign</option>
									<option value="2" <?php if($resultpage['companyType']==2){ echo "selected"; }?>>Interstate</option>
									<option value="3" <?php if($resultpage['companyType']==3){ echo "selected"; }?>>Local</option>
									<option value="4" <?php if($resultpage['companyType']==4){ echo "selected"; }?>>Internal</option>
								</select>
							</div>
						</div>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input name="companyId" type="text" class="form-control" id="companyId" value="<?php echo $resultpage['companyId']; ?>" readonly  maxlength="200">
							</div>
						</div>
					...
					<div class="row" style="margin-top:20px;">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input name="shortname" type="text" class="form-control" id="shortname" value="<?php echo $resultpage['companyShortName']; ?>" readonly  maxlength="200">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								?>
						<select id="businessSegment" class="select2 form-control"  name="businessSegment[]" multiple="multiple">
					...
					<div class="col-md-4">
							<div class="form-group">
								...
								?>
						<select id="productCategory" class="select2 form-control"  name="productCategory[]" multiple="multiple">
						 <option value="" disabled="disabled">Select</option>
						<?php
				...
				<div class="row" style="margin-top:20px;">
						<div class="col-md-4">
							<div class="form-group">
								<label>Email</label>
								<input name="email" type="text" class="form-control" id="email" value="<?php echo $resultpage['email']; ?>"   maxlength="200">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								<label>Phone</label>
								<input name="phone" type="number" class="form-control" id="phone" value="<?php echo $resultpage['phone']; ?>"   maxlength="200">
							</div>
						</div>
					...
					<option value="<?php echo $resListing['id']; ?>" <?php if($resultpage['companyCurrency']==$resListing['id']){ ?> selected="selected" <?php } ?>><?php echo $resListing['name']; ?></option>
					<?php } ?>
					...
					<input name="financialbegin" type="text" class="form-control datepickernew" id="financialbegin" value="<?php if($resultpage['financialbegin']!='0000-00-00'){ echo date('d-m-Y',strtotime($resultpage['financialbegin'])); } ?>" readonly="">
					...
					<input name="bookbegin" type="text" class="form-control datepickernew" id="bookbegin" value="<?php if($resultpage['bookbegin']!='0000-00-00'){ echo date('d-m-Y',strtotime($resultpage['bookbegin'])); } ?>" readonly="">
...
$( function(){
	$( ".datepickernew" ).datepicker();
						...
						<div class="col-xl-4">
												...
												<div class="card">
															<div class="card-header bg-white">
																<h6 class="card-title">Address Information <span style=" float:right; font-size: 13px;"> <a href="#" onClick="opmodalpop(' Add Address','modalpop.php?action=addressmaster&parentId=<?php echo encode($resultpage['id']); ?>&type=company&module=<?php echo $_GET['module']; ?>','500px','auto');" data-toggle="modal" data-target="#modalpop" aria-expanded="false" >+Add New</a></span></h6>
													...
													<?php
													$sno=1;
													$rs=GetPageRecord('*',_ADDRESS_MASTER_,'1 and addressParent="'.$resultpage['id'].'" and addressType="company"');
													...
													<a href="#" onClick="opmodalpop(' Edit Address','modalpop.php?action=addressmaster&parentId=<?php echo encode($resultpage['id']); ?>&id=<?php echo encode($resultadd['id']); ?>&type=company&module=<?php echo $_GET['module']; ?>','500px','auto');" data-toggle="modal" data-target="#modalpop" aria-expanded="false"><span style="float:right; margin-right: 7px;">Edit</span></a>
													</p>
							...
							<?php
							$sr=1;
							$rs2=GetPageRecord('*','contactPersonMaster','buyerId="'.$resultpage['id'].'" and type="company" order by id desc');
							...
							<tr class="border-top-info">
								...
								<a href="#" onclick="opmodalpop(' Edit Contact','modalpop.php?action=contactdetailmaster&buyerId=<?php echo $resultpage['id'] ?>&id=<?php echo encode($userss['id']); ?>&type=company&module=<?php echo $_GET['module']; ?>','600px','auto');" data-toggle="modal" data-target="#modalpop"  aria-expanded="false"><button type="button" class="btn btn-primary" style="padding:5px;"><i class="fa fa-pencil" aria-hidden="true" style=" color: #fffffff1;   font-size: 16px; "></i></button></a>								</div>								</td>
							</tr>
							<?php $sr++; } ?>
							</tbody>
						</table>
						...
						<?php } ?>
										...
										<div class="card" style="width:100%">
							<div class="card-body listc">
								<div style="padding: 5px;font-weight: 500; color: #524f4f; width:100%"><span>Brand Information</span> <span style=" float:right;"><a href="#" onclick="opmodalpop(' Add Brand','modalpop.php?action=brandmaster&buyerId=<?php echo $resultpage['id'] ?>','600px','auto');" data-toggle="modal" data-target="#modalpop"  aria-expanded="false">+Add New Brand</a></span></div>
								<table class="table table-bordered">
							<thead style="background-color: #dfffef;">
								<tr class="border-top-info">
									<th>Sr. No#</th>
						...
						<?php } ?>
										...
										<div class="tab-pane fade" id="solid-rounded-justified-tab3">
											...
											<div class="card" style="width:100%">
							<div class="card-body listc">
								<div style="padding: 5px;font-weight: 500; color: #524f4f; width:100%"><span>Financial Information</span> <span style=" float:right;"><a href="#" onClick="opmodalpop(' Add Details','modalpop.php?action=bankdetailmaster&masterId=<?php echo encode($resultpage['id']); ?>&type=company&module=<?php echo $_GET['module']; ?>','700px','auto');" data-toggle="modal" data-target="#modalpop" aria-expanded="false" >+Add New</a></span></div>
								<table class="table table-bordered">
							<thead style="background-color: #dfffef;">
								<tr class="border-top-info">
									<th>Bank Name</th>
							...
							<?php
							$sr=1;
							$rsBank=GetPageRecord('*','bankDetailsMaster','masterId="'.$resultpage['id'].'" and type="company" order by id desc');
							...
							<tr class="border-top-info">
								...
								<td><div class="btn-group">
								<a href="#" onclick="opmodalpop(' Edit Details','modalpop.php?action=bankdetailmaster&masterId=<?php echo encode($resultpage['id']) ?>&id=<?php echo encode($bankdetail['id']); ?>&type=company&module=<?php echo $_GET['module']; ?>','700px','auto');" data-toggle="modal" data-target="#modalpop"  aria-expanded="false"><button type="button" class="btn btn-primary" style="padding:5px;"><i class="fa fa-pencil" aria-hidden="true" style=" color: #fffffff1;   font-size: 16px; "></i></button></a>								</div>								</td>
							</tr>
							<?php $sr++; } ?>
							</tbody>
						</table>
						...
						<?php } ?>
											...
											<div class="card" style="width:100%">
							<div class="card-body listc">
								<div style="padding: 5px;font-weight: 500; color: #524f4f; width:100%"><span>Document Management</span> <span style=" float:right;"><a href="#" onClick="opmodalpop(' Add Details','modalpop.php?action=addbuyerdocuments&masterId=<?php echo encode($resultpage['id']); ?>&type=company&module=<?php echo $_GET['module']; ?>','700px','auto');" data-toggle="modal" data-target="#modalpop" aria-expanded="false" >+Add New</a></span></div>
								<table class="table table-bordered">
							<thead style="background-color: #dfffef;">
								<tr class="border-top-info">
									<th>Document&nbsp;Type</th>
							...
							<?php
							$sr=1;
							$kkkk=GetPageRecord('*','documentMaster','masterId="'.$resultpage['id'].'" and type="company" order by id desc');
							...
							<tr class="border-top-info">
								...
								<td><div class="btn-group">
								<a href="#" onclick="opmodalpop(' Edit Details','modalpop.php?action=addbuyerdocuments&masterId=<?php echo encode($resultpage['id']) ?>&id=<?php echo encode($documentname['id']); ?>&type=company&module=<?php echo $_GET['module']; ?>','700px','auto');" data-toggle="modal" data-target="#modalpop"  aria-expanded="false"><button type="button" class="btn btn-primary" style="padding:5px;"><i class="fa fa-pencil" aria-hidden="true" style=" color: #fffffff1;   font-size: 16px; "></i></button></a>								</div>								</td>
							</tr>
							<?php $sr++; } ?>
							</tbody>
						</table>
...
$where='where '.$wheresearchassign.'  subject!=""  '.$stylestatus.' '.$assignTo .' '.$assignToMerchant.' '.$categoryId.' '.$tatstatusCondition.' and deletestatus=0 order by id desc';
}else{
$where='where '.$wheresearchassign.' subject!="" '.$stylestatus.' '.$assignTo .' '.$categoryId.' '.$tatstatusCondition.' and deletestatus=0 order by id desc';
}
...
.card-group-control-right .card-body{width:100%;}
 ...
 function deletethisaddress(id){
	...
	if(confirmFirst==true){
		...
		window.location.href = 'showpage.crm?module=<?php echo $_GET['module']; ?>&view=yes&id='+buyerid+'&did='+id; //delete address
	}
 }
