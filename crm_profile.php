...
?>
   ...
   <a href="#" onclick="opmodalpop(' Add Profile','modalpop.php?action=<?php echo $_GET['module']; ?>','600px','auto');" data-toggle="modal" data-target="#modalpop" class="btn bg-teal-400" aria-expanded="false" style="background-color: #03d873b8;"><i class="fa fa-plus" aria-hidden="true"></i> Add Profile</a>
...
?>
						...
						<tr role="row" class="odd">
								<td align="left" class="sorting_1" tabindex="0"> <a href="showpage.crm?module=<?php echo $_GET['module']; ?>&add=yes&id=<?php echo encode($resultlists['id']); ?>"><?php echo $resultlists['profileName']; ?></a></td>
