 <div class="page-content"> 
  ...
  <tr height="50" style="padding: 10px; font-size: 11px; font-weight: 600; background-color: #F8F8F8; margin-top: 10px; position: relative;">
    ...
    <td width="7%"><div align="center">Extra Cut in indent</div></td>
    ...
    <tbody id="addrow"></tbody>
				...
				if(id==1){
				$("#addrow").load('loadtrimwastageallowance.php?add=1');
				}else{
				$("#addrow").load('loadtrimwastageallowance.php');
				}
				...
				if(checkyes==true){
				$('#addrow').load('loadtrimwastageallowance.php?id='+id+'&deletestatus=yes');
				}
				}
				</script> 
</table>
