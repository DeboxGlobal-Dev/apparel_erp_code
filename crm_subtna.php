...
$where2='styleId="'.$resultlists['id'].'"';
$selectstatus='*';
$rsstatus1=GetPageRecord($selectstatus,'styleColorDetailMaster',$where2);
if(mysql_num_rows($rsstatus1) > "0") {
...
$where1='styleId="'.$resultlists['id'].'"';
$rsstatusaf=GetPageRecord($selectstatus,'subtnaMaster',$where1);
$operationData=mysqli_fetch_array($rsstatusaf);
?>
                      <tr>
             <td><a href="showpage.crm?module=<?php echo $_GET['module']; ?>&add=yes&styleid=<?php echo encode($resultlists['id']); ?>"><?php echo '#'.$resultlists['styleRefId']; ?>
                ...
                ?>
                        ...
                        <td style="display: none;"><?php echo getUserName($resultas['pdmerchant']); ?></td>
            <td style="display:none;"><?php echo getUserName($resultas['productionmerchant']); ?></td>

                        <td align="left">
<?php if(mysql_num_rows($rsstatusaf) > "0" && $operationData['cadreceived'] !="" && $operationData['standardreceived'] !="" && $operationData['firstsubmitdate'] !="" && $operationData['firstsubmitcomment'] !="" && $operationData['secondsubmitdate'] !="" && $operationData['secondsubmitcomment'] !="" && $operationData['approvalcomment'] !="" && $operationData['indentapproved'] !="" && $operationData['fptapproved'] !="" && $operationData['fobsubmit'] !="" && $operationData['cadreceived'] !="," && $operationData['standardreceived'] !="," && $operationData['firstsubmitdate'] !="," && $operationData['firstsubmitcomment'] !="," && $operationData['secondsubmitdate'] !="," && $operationData['secondsubmitcomment'] !="," && $operationData['approvalcomment'] !="," && $operationData['indentapproved'] !="," && $operationData['fptapproved'] !="," && $operationData['fobsubmit'] !=",") {   ?>

   <span class="badge" style="background-color:green; color:#FFFFFF; position: relative;">Complete</span>

   <?php } else if(mysql_num_rows($rsstatusaf) > "0" && ($operationData['cadreceived'] == "," || $operationData['standardreceived'] =="," || $operationData['firstsubmitdate'] =="," || $operationData['firstsubmitcomment'] =="," || $operationData['secondsubmitdate'] =="," || $operationData['secondsubmitcomment'] =="," || $operationData['approvalcomment'] =="," || $operationData['indentapproved'] =="," || $operationData['fptapproved'] =="," || $operationData['fobsubmit'] == "," || $operationData['cadreceived'] == "" || $operationData['standardreceived'] =="" || $operationData['firstsubmitdate'] =="" || $operationData['firstsubmitcomment'] =="" || $operationData['secondsubmitdate'] =="" || $operationData['secondsubmitcomment'] =="" || $operationData['approvalcomment'] =="" || $operationData['indentapproved'] =="" || $operationData['fptapproved'] =="" || $operationData['fobsubmit'] == "")) {  ?>
                    <span class="badge" style="background-color:orange; color:#FFFFFF; position: relative;">Partial</span>
                  <?php } else { ?>
                    <span class="badge" style="background-color:red; color:#FFFFFF; position: relative;">Pending</span>
                    <?php } ?>
                        </td>
                         <td>
					  ...
					  <div style="width:200px;">
						...
						<a href="download-sub-tna.php?styleid=<?php echo encode($resultlists['id']); ?>" target="_blank" style="background: #0288d1; outline: none; color: #fff; padding: 5px; border-radius: 2px; cursor: pointer; width: 95px; display: block; float:left;  text-align:center;"><i class="fa fa-download" aria-hidden="true"></i> Excel</a>
						<a href="tcpdf/examples/genratesbtnapdf.php?pageurl=<?php echo $fullurl; ?>sbtnapdf.php?styleid=<?php echo encode($resultlists['id']); ?>" target="_blank" style="background: #e71c22; outline: none; color: #fff; padding: 5px; border-radius: 2px; cursor: pointer; width: 95px; display: block; float:right; margin-left:5px; text-align:center;"><i class="fa fa-download" aria-hidden="true"></i> PDF</a>
						</div>
