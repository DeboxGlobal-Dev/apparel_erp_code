...
$aa=GetPageRecord('*','styleSubCategoryMaster','approved="2" and styleId="'.$resultlists['id'].'"');
$appCount=mysql_num_rows($aa);
if($appCount>0){
?>
							...
							<td align="center"><?php echo $resultlists['displayId']; ?></td>
								...
								<td><a href="showpage.crm?module=approvedindent&add=yes&styleid=<?php echo encode($resultlists['id']); ?>&indentno=<?php echo encode($resultqty['indentNumber']); ?>"><?php echo $resultqty['indentNumber']; ?></a></td>
							   ...
							   <td><?php echo $resultqty['qtyTotal']; ?></td>
								...
								<td><a href="showpage.crm?module=approvedindent&add=yes&styleid=<?php echo encode($resultlists['id']); ?>"><span class="badge" style="cursor:pointer;background-color:green; color:#fff; position: relative;width: 142px; font-size: 11px; padding: 6px;">View Indent</span></a></td>
