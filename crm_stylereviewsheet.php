...
?>
                      <tr>
             <td><a href="showpage.crm?module=<?php echo $_GET['module']; ?>&add=yes&styleid=<?php echo encode($resultlists['id']); ?>"><?php echo '#'.$resultlists['styleRefId']; ?></a></td>
                ...
                echo $factotyData['name'];
                         ?></td>
                     <td align="center"><a href="download-stylereviewsheet.php?styleid=<?php echo encode($resultlists['id']); ?>" target="_blank"><span class="badge" style="color: white;background-color:#277fa0;font-size: 12px;">Export to Excel</span></a></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
