                  ...
                  <div class="col-md-2">
                      <div class="">
                          <select class="form-control" name="accountName" id="accountName">
                              ...
                              ?>
                              <option value="<?php echo $resultList->AccountCode; ?>"
          ...
          <form name="listform" id="listform" method="get" >
              ...
              <table class="table table-bordered table-hover no-footer apparelclass">
                  ...
                  <!-- <tr style="background-color: #646464; color: #fff; text-align: center;">
                      <td colspan="2">Account - <?php echo $AccountDetailsF['AccountName']; ?>
                      </td>
...
echo $OpeningBalance; ?></td>
                      ...
                      <td colspan="3">Current Balance - <?php
...
echo $MainBalance; ?></td>
                  ...
                  <tbody id="allhotellisting">
                      ...
                      <tr>
                          ...
                          <td align="center">
                              <div align="left"><?php echo $resultList['AccountName']; ?>
                              </div>
                          </td>
                          <td align="center">
