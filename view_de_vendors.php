			...
			<div class="content">
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					...
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-1" style="cursor:pointer;"  onclick="cancel();" ></i> Vendor Detail</h4>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
											    ...
											    <?php
								$myArray = explode(',', $editresult['bussinessType']);
