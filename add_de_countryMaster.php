...
deleteRecord('countryMaster',$where);

$dateAdded=time();
$namevalue ='name="",addedBy='.$_SESSION['userid'].',dateAdded='.$dateAdded.',status="1"';
$lastId = addlistinggetlastid('countryMaster',$namevalue);
}
			...
			<div class="content">
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					...
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-1" style="cursor:pointer;"  <?php if($_REQUEST['id']!=''){ ?> onclick="view('<?php echo $_REQUEST['id']; ?>');"<?php } else { ?> onclick="cancel();"<?php  } ?> ></i> 	<?php if($_REQUEST['id']!=''){ echo 'Edit'; } else { echo 'Add'; } ?> Country </h4>
...
<div class="card-body">
					...
					Enter your Country's  name  and hint will search for additional data.			    </div>
					</div>
				</div>
