...
?>
                   ...
                   <!----start--->
                      ...
                      <td colspan="2"  style="border-top:1px solid #ccc!important;border:1px solid #ccc">
                             <table class="table-hover" width="100%" style="border:1px solid black">
                        <tr>
                         <td><div style="text-transform:capitalize"><b>Critical Operation</b></div></td>
                         <td>	<?php
							$abc=GetPageRecord('*','assemblyoperationsMaster','1 and status=1 and deletestatus=0 order by name asc');
							while($critical=mysqli_fetch_array($abc)) {
...
?>
                         <td><div style="text-transform:capitalize"><b>High SAM Operation</b></div></td>
                         <td> <?php
                        ...
                        <tr>
                         <td><div style="text-transform:capitalize"><b>Additional Operation</b></div></td>
                         <td> <?php
...
?>
                            ...
                            <?php } ?></td>
                         <td><div style="text-transform:capitalize"><b>Additional Process</b></div></td>
                         <td><?php echo $operationData['addProcess'] ?></td>
                        </tr>
                        <tr>
                         <td><div style="text-transform:capitalize"><b>Technical Name</b></div></td>
                         <td>
                                  <?php
					 ...
					 ?>
                         ...
                         <td><div style="text-transform:capitalize"><b>Technical Approval/Submission</b></div></td>
                         <td><?php if($operationData['techFinal']=="1"){
