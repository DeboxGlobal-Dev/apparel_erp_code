                  ...
                  <table width="100%" border="1" cellpadding="5" cellspacing="0" class="table" style="font-size: 12px !important; width: 100%; border: 1px solid #ccc !important;">
                    <tr style="padding: 10px; font-size: 13px; font-weight: 600; background-color: #F8F8F8; margin-top: 0; position: relative;">
                      ...
                      <?php for($w=1;$w<=1;$w++){?>
                        ...
                        <td><input type="number" name="credit[]" id="credit_<?php echo $w; ?>" class="creditsum form-control" value="0" ></td>
                        <td><input type="number" name="debit[]" id="debit_<?php echo $w; ?>" class="creditsum form-control" value="0" ></td>
                      </tr>
                      <?php } ?>
                      <tr id="commonrow">
...
<script>
        ...
        $(document).ready(function () {
            $(".add-row").click(function () {
				...
				$no=1;
				foreach($accountData->AccountNameData as $resultList){
				?><option value='<?php echo $resultList->AccountCode; ?>'><?php echo $resultList->AccountName; ?> [<?php echo $resultList->AccountCode; ?>]</option><?php } } } ?></select></td><td><input type='text' name='code[]' id='code_"+rowno+"' class='debitsum form-control'  value=''></td><td><input type='number' name='credit[]' id='credit_"+rowno+"' class='creditsum form-control' value='0' ></td><td><input type='number' name='debit[]' id='debit_"+rowno+"' class='creditsum form-control'  value='0'></td></tr>";
