  ...
  <div class="content-wrapper">
    <div class="content pt-0" style="margin-top:20px;">
      ...
      <div class="row">
		...
		$rrrr11=GetPageRecord('*','taskListMaster','tnatemplate="'.$editresultstyle['tnaTemplateId'].'" and criticalPath=21');
		$operationData11=mysqli_fetch_array($rrrr11);

		$where1='taskListId="'.$operationData11['id'].'" and styleId="'.decode($_GET['styleid']).'" and status=1';
		$rs22=GetPageRecord('actualDate','timeActionReport',$where1);
		$data=mysqli_fetch_array($rs22);

		?>
			<div class="col-xl-2">
              <div class="card-title"><span>Style Approval Date : <?php if($data['actualDate']!='' && $data['actualDate']!='1970-01-01' && $data['actualDate']!='0000-00-00'){ echo date('d-m-Y', strtotime($data['actualDate'])); } ?></span> </div>
            </div>
			<div class="col-xl-1">
