...
<a href="download-projection.php" class="btn bg-teal-400 addnotify" aria-expanded="false" style="background-color: #03d873b8; margin-left: 66px;">Download Excel</a>
		  ...
		  <form name="listform" id="listform" method="get">
            ...
            <table class="table table-bordered table-responsive">
              <tr height="20" style="background-color: #e5fbfa; color: #000;">
                ...
                <td width="4085"><div align="center"><strong>Projected&nbsp;Quantity </strong></div></td>
                <td width="4085"><div align="left"><strong>Valid&nbsp;Till</strong></div></td>
                ...
                <td width="4085"><div align="center"><strong>Production&nbsp;Start&nbsp;Date</strong></div></td>
                <td width="4085"><div align="center"><strong>Projected&nbsp;Delivery&nbsp;Date</strong></div></td>
                <td width="4085"><div align="center"><strong>Unit&nbsp;Allocation</strong></div></td>
              </tr>
...
$dataRangeFinal=date('Y-m-d', strtotime("-28 days"));

$where='where '.$wheresearchassign.' deletestatus=0 and sampleStyle=1 and orderQty=0 and receivedDate> "'.$dataRangeFinal.'" '.$buyerId.' '.$brandId.' '.$valueEdition.' and buyerId!="" and buyerId!=0 order by id desc';
...
?>
              <tr>
                ...
                <td><div align="left"><div style="width:80px;"><?php echo date('d-m-Y',strtotime($qdata['receivedDate'].' +28 Days')); ?></div></div></td>
...
?>
				...
				<select name="factoryId" id="bomPlacement" style="width: fit-content; text-align: center; padding: 5px;" onchange="saveUnitFactory<?php echo $qdata['id']; ?>(this.value);">
<option value="">Select</option>
<?php
$comQ=GetPageRecord('id,name','factoryMaster','1 order by id');
while($compLocaData=mysqli_fetch_array($comQ)){ ?>
<option value="<?php echo $compLocaData['id']; ?>" <?php if($compLocaData['id']==$qdata['unitFactory']){ ?> selected="selected" <?php } ?>><?php echo $compLocaData['name']; ?></option>
<?php } ?>
</select>
