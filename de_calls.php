...
<div class="page-content">
 ...
 <a href="#" data-toggle="modal" data-target="#modalpop" onClick="opmodalpop(' Schedule Call','modalpop.php?action=addcall','600px','auto');" class="btn bg-teal-400"  aria-expanded="false"  style="    background-color: #03d873b8;"><i class="fa fa-plus" aria-hidden="true"></i> Schedule Call</a>
 ...
 var pie_donut_element = document.getElementById('pie_donut');
        ...
        if (pie_basic_element) {
            ...
            pie_basic.setOption({
                ...
                // Colors
                color: [
                    '#4caf50','#f44336','#00bcd4','#ffb980','#d87a80',
                    '#4caf50','#00bcd4','#4caf50','#95706d','#dc69aa',
                    '#4caf50','#00bcd4','#4caf50','#f5994e','#c05050',
                    '#4caf50','#00bcd4','#4caf50','#6f5553','#c14089'
                ],
                ...
                series: [{
					...
					$rs=GetPageRecord('COUNT(id) as totalid, status ','callsMaster',$where);
