...
$select1='*';
$where1='id=1';
$rs1=GetPageRecord($select1,'aboutus',$where1);
...
?>
    ...
    .catch( error => {
        console.error( error );
					...
					<input name="module" type="hidden" id="module" value="aboutus" />
					<input name="action" type="hidden" id="action" value="editmission" />
			</form>
			</div>
