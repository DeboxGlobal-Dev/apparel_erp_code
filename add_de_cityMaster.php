...
<?php } ?>
					...
					Enter your City's  name  and hint will search for additional data.			    </div>
					</div>
				</div>
...
<input name="editId" type="hidden" id="editId" value="<?php echo encode($lastId); ?>" /><?php
		...
		<input name="action" type="hidden" id="action" value="editCity" />
