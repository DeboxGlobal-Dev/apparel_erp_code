...
$('#load_bom_list<?php echo $costsheetVersionId; ?>').load("load_bom_list.php?styleId=<?php echo $editresultstyle['id'];?>&subCategoryId=<?php echo $editresultstyle['subCategoryId'];?>&page=sampleanalysematerial&costsheetVersionId=<?php echo $costsheetVersionId; ?>");
}
