...
?>
				...
				// 	$grnDataq=GetPageRecord('*','grnMaster','1 and styleId="'.$resultlists['id'].'"  and parentId in (select id from grnMaster where grnNo!="") and materialId in (select id from materialMaster where materialtype=3) order by id');
