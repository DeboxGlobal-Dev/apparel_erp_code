...
?>
                         ...
                         <td><span class="badge" style="cursor:pointer;background-color:green; color:#fff; position: relative;width: 142px; font-size: 11px; padding: 6px;"  onclick="opmodalpop('Add Techpack','modalpop.php?action=uploadatechpackpattern&styleId=<?php echo encode($resultlists['id']); ?>&module=<?php echo $_GET['module']; ?>','600px','auto');" data-toggle="modal" data-target="#modalpop">
									Add&nbsp;Techpack</span></td>
                        <td align="center"><?php if($resultlists['attachmentNewMail']!=''){ ?>
                          <a href="<?php echo $fullurl; ?>attachment/<?php echo $resultlists['attachmentNewMail']; ?>" target="blank">&nbsp;&nbsp;<i class="fa fa-download" aria-hidden="true" style="display: inherit;margin-right: 5px;"></i>Download</a>
                          <?php } ?></td>
                      </tr>
                      <?php } ?>
                    </tbody>
