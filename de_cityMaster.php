...
<div class="page-content">
 ...
 <a href="#" onclick="opmodalpop(' Add City','modalpop.php?action=addcity','600px','auto');"  class="btn bg-teal-400" data-toggle="modal" data-target="#modalpop"   style="    background-color: #03d873b8;"><i class="fa fa-plus" aria-hidden="true"></i> Create New</a>
					...
					<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"> <div class="datatable-scroll"><table class="table table-bordered table-hover datatable-highlight dataTable no-footer" id="DataTables_Table_2" role="grid" aria-describedby="DataTables_Table_2_info">
						<thead>
							<tr role="row">
							  ...
							  <th rowspan="1" align="left" class="sorting" tabindex="0" aria-controls="DataTables_Table_2" aria-label="Last Name: activate to sort column ascending">Country</th>
							  <th colspan="1" rowspan="1" align="left" class="sorting" tabindex="0" aria-controls="DataTables_Table_2" aria-label="Last Name: activate to sort column ascending">Last&nbsp;Modify By </th>
							  <th colspan="1" rowspan="1" align="left" class="sorting" tabindex="0" aria-controls="DataTables_Table_2" aria-label="Last Name: activate to sort column ascending">Last&nbsp;Modify Date </th>
...
?>
						...
						<tr role="row" class="odd">
								<td align="left" class="sorting_1"><a   title="<?php echo $resultlists['name']; ?>" style=" color:#2196f3; display:block; min-width:120px; " href="#"  onclick="opmodalpop(' Edit City','modalpop.php?action=addcity&id=<?php echo encode($resultlists['id']); ?>','600px','auto');"  class="shorttextcard" data-toggle="modal" data-target="#modalpop"  ><?php echo strip($resultlists['name']); ?></a> </td>
								<td align="left" class=""><div class="shorttextcard" ><?php echo getCountryName($resultlists['countryId']); ?></div></td>
								<td width="20%" align="left" class=""><?php echo getUserName($resultlists['modifyBy']); ?></td>
								<td width="20%" align="left"><?php if($resultlists['modifyDate']!=""){ echo $resultlists['modifyDate']; } ?></td>
								<td width="0%" align="left" style="display:none;"></td>
								<td width="0%" align="left" style="display:none;"> </td>
						  </tr>
        ...
        if (pie_basic_element) {
            ...
            pie_basic.setOption({
                ...
                series: [{
					...
					$rs='';
					$select='*';
					$where=' status=0 group by countryId order by id asc';
					$rs=GetPageRecord('COUNT(id) as totalid, countryId','cityMaster',$where);
					while($resListing=mysqli_fetch_array($rs)){ if($resListing['countryId']!=''){ if($resListing['countryId']!='0'){ ?>
						{value: <?php echo $resListing['totalid']; ?>, name: '<?php echo  getCountryName($resListing['countryId']); ?>'},
					<?php } } } ?>
                    ]
                }]
            });
