...
<div class="page-content">
 ...
 <a href="#" data-toggle="modal" data-target="#modalpop" onClick="opmodalpop(' Schedule Meeting','modalpop.php?action=addmeeting','600px','auto');" class="btn bg-teal-400"  aria-expanded="false"  style="    background-color: #03d873b8;"><i class="fa fa-plus" aria-hidden="true"></i> Schedule Meeting</a>
        ...
        if (pie_basic_element) {
            ...
            pie_basic.setOption({
                ...
                series: [{
					...
					$rs=GetPageRecord('COUNT(id) as totalid, status ','meetingsMaster',$where);
