              ...
              <div class="row specialclass">
                ...
                <form action="" method="get">
                  ...
                  <div class="col-md-12" style="padding:0px;">
					...
					<?php if($loginuserprofileId!=154 && $loginuserprofileId!=154){ ?>
...
if($loginuserprofileId==154){

$where='where id in (select styleId from styleSubCategoryMaster  where FIND_IN_SET('.$_SESSION['userid'].',assignTo)) and subject!="" and sampleStyle="2"  deletestatus=0 order by id desc';

}elseif($loginuserprofileId==155){



$where='where id in (select styleId from styleSubCategoryMaster  where  FIND_IN_SET('.$_SESSION['userid'].',assignToPurMerchant)) and subject!="" and sampleStyle="2" and deletestatus=0 order by id desc';

}else{

$where='where '.$wheresearchassign.' subject!="" and sampleStyle="2" and deletestatus=0 order by id desc';

}



//$where='where '.$wheresearchassign.' subject!="" '.$stylerefCondition.' and deletestatus=0 order by id desc';
...
?>
					  ...
					  <tr role="row" class="odd">
                        ...
                        <td><a href="showpage.crm?module=SamplingBOM&add=yes&styleid=<?php echo encode($resultlists['id']); ?>"><?php echo '#'.$resultlists['styleRefId']; ?>
