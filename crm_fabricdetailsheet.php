                ...
                <table class="table table-bordered table-hover datatable-highlight dataTable no-footer" id="DataTables_Table_2" role="grid" aria-describedby="DataTables_Table_2_info">
                  <thead style="background-color: #f5f5f5;">
                    <tr role="row">
                      ...
                      <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1">Style#</th>
                      <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1">Style&nbsp;Name</th>
                      <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1">Fabrics</th>
...
?>
                    ...
                    <tr role="row" class="odd">
                      ...
                      <td><a><?php echo '#'.$resultlists['styleRefId']; ?>
					  ...
					  <td>
					  <?php
					  $rsfab=GetPageRecord('*','styleSubCategoryMaster','materialType=1 and styleId="'.$resultlists['id'].'" and costsheetVersionId="'.$resultlists['defaultcostsheetVersionId'].'" and name!=""');
					  while($resultfab=mysqli_fetch_array($rsfab)){
					  ...
					  $a=GetPageRecord('*','suppliersMaster','id="'.$rslistss['mfgName'].'"');
						$currenname=mysqli_fetch_array($a);

					 ?>
					<a href="showpage.crm?module=fdsmaster&add=yes&id=<?php echo encode($rslistss['id']); ?>&status=1"><span style="padding: 5px 10px; background-color: #0097a7; color: #fff; margin-right: 2px; font-size: 12px; margin-bottom:5px;display: inline-block; cursor:pointer;"><?php echo $resultfab['name'].' - '; ?><span style="color:#00ffb8"><?php echo $currenname['name']; ?></span></span></a>
					<?php } ?>
					  </td>
