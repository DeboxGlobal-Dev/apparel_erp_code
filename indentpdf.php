...
?>
                      ...
                      <table width="100%" class="table table-bordered table-responsive" style="margin-bottom:5px;">
						...
						<table width="100%" class="table table-bordered table-responsive" style="margin-bottom:5px;">
                          <tbody style="width: 100%;display: inline-table;">
                            <tr class="card-body">
                              <td width="31%"> <strong>Indent No: </strong><span class="badge badge-warning" style="font-size: 11px;"><?php echo decode($_GET['indentno']); ?></span></td>
						...
						?>
						 ...
						 <table width="100%" border="1" cellspacing="2" cellpadding="2" style="border: 1px solid #ccc; margin-top:20px;">
						  <tr style="font-size: 15px; background-color: #fff7b3; font-weight: 700;">
		...
		$rsssqtyzx=GetPageRecord('SUM(gdQty) as trsum','purchaseOrderStyleMaster','1 and parentId="'.$resultcolor['id'].'" and color="'.$resultdest['color'].'" and finish="'.$resultdest['finish'].'"');
	$rsssqtylistzx=mysqli_fetch_array($rsssqtyzx);
							...
							echo $fca=ceil($sizeqty = $rsssqtylist['gdQty'] + $fcalc);
							...
							if($rsssqtylist['gdQty'] > 0){
						  	...
						  	$resultpro=mysqli_fetch_array($rspro);
								...
								$calc1=$rsssqtylist['gdQty'] * $totalallowance;
							$fcalc1=$calc1/100;

							echo $fca= ceil($sizeqty = $rsssqtylist['gdQty'] + $fcalc1);
				// 			echo $sizeqty = $rsssqtylist['gdQty'];
							  $total = $total+$fca;
							...
							$calc2=$rsssqtylist['gdQty'] * $totalallowance;
							$fcalc2=$calc2/100;

							echo $fca=ceil($sizeqty = $rsssqtylist['gdQty'] + $fcalc2);
				...
				// 			echo $sizeqty = $rsssqtylist['gdQty'];
							...
							$rsssqtylist=mysqli_fetch_array($rsssqty);
						  	...
						  	$resultpro=mysqli_fetch_array($rspro);
								...
								$calc3=$rsssqtylist['gdQty'] * $totalallowance;
							$fcalc3=$calc3/100;

							echo $fca=ceil($sizeqty = $rsssqtylist['gdQty'] + $fcalc3);
				...
				// 			echo $sizeqty = $rsssqtylist['gdQty'];
							...
							$pper=$pper+$rsssqtylist['gdQty'];
						  	...
						  	$resultpro=mysqli_fetch_array($rspro);
								...
								$calc5=$rsssqtylist['gdQty'] * $totalallowance;
							$fcalc5=$calc5/100;

							echo $fca = ceil($sizeqty = $rsssqtylist['gdQty'] + $fcalc5);
				...
				// 			echo $sizeqty = $rsssqtylist['gdQty'];
							...
							$pper=$pper+$rsssqtylist['gdQty'];
						  	...
						  	$resultpro=mysqli_fetch_array($rspro);
								...
								$calc6=$rsssqtylist['gdQty'] * $totalallowance;
							$fcalc6=$calc6/100;

							echo $fca= ceil($sizeqty = $rsssqtylist['gdQty'] + $fcalc6);
				...
				// 			echo $sizeqty = $rsssqtylist['gdQty'];
							...
							$rsssqtylist=mysqli_fetch_array($rsssqty);
						  	...
						  	$pper=$pper+$rsssqtylist['gdQty'];
								...
								$calc7=$rsssqtylist['gdQty'] * $totalallowance;
							$fcalc7=$calc7/100;

							echo $fca= ceil($sizeqty = $rsssqtylist['gdQty'] + $fcalc7);

				// 			echo $rsssqtylist['gdQty'];
							$total = $total+$rsssqtylist['gdQty'];
							}
							?>
							</td>
							<td>-</td>
						  ...
						  //	$total = round($total+(($total*$totalallowance)/100));
							echo $total;
							$fianlTotal = $fianlTotal+$total;  ?></td>
						  </tr>
						  <?php }  } ?>
						  <tr style="font-size: 15px; background-color: #f7f7f7; font-weight: 700;">
							<td colspan="9">&nbsp;</td>
					    ...
					    <table width="100%" class="table table-bordered table-responsive forbom" id="tableid11" style="display:block;">
                          <tbody style="width: 100%;display: inline-table;">
                            <tr class="card-body" style="background-color: #fff7b3;;">
							 <td align="center"><strong></strong><input  name="materialCheckAll" type="checkbox" class="checkalldeletematerial" id="materialCheckAll" style="height: 17px;width: 50px;margin-top: 0;text-align: center;" /></td>
                              <td width="7.5%" align="center"><strong>Material/Item&nbsp;Name</strong></td>
                              <td width="7.5%" align="center"><strong>Description</strong></td>
							  <td width="7.5%"  align="center"><strong>Width</strong></td>
                              <td width="7.5%"  align="center"><strong>Qty/Avg</strong></td>
                              <td width="7.5%"  align="center"><strong>UOM</strong></td>
                              <!--<td width="12%" align="center"><strong>Supplier&nbsp;Id</strong></td>
                              <td width="12%" align="center"><strong>Supplier&nbsp;Name</strong></td>-->
                              <td width="7.5%"  align="center"><strong>Rate</strong></td>
							  <td width="7.5%"  align="center" style="display:none;"><strong>Value&nbsp;Of&nbsp;1&nbsp;Piece</strong></td>
                        	  <td width="7.5%"  align="center"><strong>Color</strong></td>
                             <!-- <td width="12%" align="center"><strong>Size</strong></td>-->
                              <td width="7.5%"  align="center"><strong>PO&nbsp;Qty&nbsp;(Excess)
</strong></td>
							  <td width="7.5%"  align="center"><strong>Material&nbsp;Qty</strong></td>
							  <td width="7.5%"  align="center"><strong>Material&nbsp;Value</strong></td>
							<!--  <td width="12%" align="center"><strong>Stock&nbsp;In&nbsp;Store</strong></td>-->
							 <!-- <td width="12%" align="center"><strong>Total&nbsp;allowance(%)</strong></td>-->
							  <td width="7.5%"  align="center"><strong>Order&nbsp;Qty</strong></td>
							  <td width="7.5%"  align="center"><strong>Pending&nbsp;Qty.</strong></td>
							  <td width="7.5%"  align="center"><strong>Status</strong></td>
							</tr>
							<?php
							$sNo1=0;
							$rowno=0;
						...
						?>
                            ...
                            <td>
							 <div  data-toggle="modal" data-target=""><?php echo  $resListing1['name']; ?></div>
                              ...
                              <td><?php echo $resListing1['name']; //getDescriptionName($resListing1['materialdescriptionid']); ?></td>
							  <td width="9%" align="center"><?php if($resListingtype['id']==1){ echo $resListing12['bomWidth']; } ?></td>
                              <td width="9%" align="center"><?php  echo $resListing12['avgIncWastage']; ?></td>
                              <td width="9%" align="center"><?php  echo $resListing12['bomUnit']; ?></td>
                              ...
                              <td width="8%" align="center"><?php  echo $resListing12['bomRate']; ?></td>
							  <td width="8%" align="center" style="display:none;"><?php   echo $resListing12['bomvalueonepc']; ?></td>
							  ...
							  <td width="8%" align="center"><?php 	echo $orderQty;   ?></td>
							  <td width="8%" align="center"><?php   echo $totalMaterialQty; ?></td>
							  <td width="8%" align="center"><?php echo $totalMaterialValue; ?></td>
							 ...
							 <!-- <td width="12%" align="center">
							  ...
							  <td width="8%" align="center"><?php echo $resListingIndent1['tillorderQty']; ?></td>
							  <td width="8%" align="center"><?php echo $tillTotalMaterialQty; ?></td>
							  <td width="8%" align="center">
						   ...
						   <?php echo $resListing1['name']; ?>
                              ...
                              <td width="8%" align="center"><?php echo $resListing1['name']; //getDescriptionName($resListing1['materialdescriptionid']); ?></td>
							  <td width="8%" align="center"><?php if($resListingtype['id']==1){ echo $resListing12['bomWidth']; } ?></td>
                              <td width="8%" align="center"><?php echo $resListing12['avgIncWastage']; ?></td>
                              <td width="8%" align="center"><?php echo $resListing12['bomUnit']; ?></td>
                          	  <td width="8%" align="center"><?php echo $resListing12['bomRate']; ?></td>
							  <td width="8%" align="center"><?php echo $resListing12['bomvalueonepc']; ?></td>
							  <td width="8%" align="center">
							<?php
							...
							?>
							 ...
							 <!-- <td width="12%" align="center"><?php echo $newsize; ?></td>-->
							  <td width="8%" align="center"><?php echo $orderQty;  ?></td>
							  <td width="8%" align="center"><?php  echo round($totalMaterialQty); ?></td>
							  <td width="8%" align="center"><?php echo $totalMaterialValue; ?></td>
							  <td width="8%" align="center"><span style="color:#FF0000; font-weight:600;">No</span></td>
							  <!--<td width="12%" align="center">
							  <?php
							  $perqty=0;
							  $totalallow = 0;
							  ...
							  <td width="8%" align="center"><?php echo $resListingIndent2['tillorderQtysize']; ?></td>
							  <td width="8%" align="center"><?php echo round($tillTotalMaterialQty2)+$perqty; ?></td>
							  <td width="8%" align="center">
							  <?php if($resListingIndent1['sendToBom']=='1'){ ?> <a href="#"><span class="badge" style="cursor:pointer;background-color:green; color:#fff; position: relative;width: 142px; font-size: 11px; padding: 6px;">Assigned</span></a><?php } ?>
							  </td>
