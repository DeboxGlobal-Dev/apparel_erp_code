...
$where='where 1 and fromStyle!=0 and toStyle!=0 and tabstatus=1 order by id desc';
$page=$_GET['page'];
$targetpage=$fullurl.'showpage.crm?module='.$modfile['url'].'&records='.$limit.'&searchField='.$searchField.'&assignto='.$_GET['assignto'].'&stylerefid='.$_GET['stylerefid'].'&';$rs=GetRecordList($select,'stockTransfer',$where,$limit,$page,$targetpage);
$totalentry=$rs[1];
$paging=$rs[2];
...
<tr role="row" class="odd">
	...
	<td><?php
	$rss=GetPageRecord('name','materialTypeMaster','id="'.$resultlists['categoryId'].'"');
	$resListing=mysqli_fetch_array($rss);
	echo $resListing['name']; ?></td>
	<td><?php echo getStyleRefId($resultlists['toStyle']); ?></td>
	<td><?php echo getUserName($resultlists['addedBy']); ?></td>
	<td><?php echo getUserName($resultlists['approvedBy']); ?></td>
</tr>
<?php  } if($no==0){ ?>
<tr>
