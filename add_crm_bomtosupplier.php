    ...
    <div class="content pt-0" style="margin-top:20px;">
      <div class="row">
        <div class="col-xl-12">
          ...
          }elseif($resListingIndent1['requisitionNo']!='' && $resListingIndent1['oldMaterialId']=='0'){
            $poName = substr(getPoTypeName($resListingIndent1['poTypeId']), 0, 3);
          }else{
...
$countPending33=mysqli_fetch_array($list233);
				  ...
				  <td align="center"><?php if($resListingIndent1['bomPoStatus']=='1'){  ?> <a href="#"><span class="badge" style="cursor:pointer;background-color:green; color:#fff; position: relative;width: 142px; font-size: 11px; padding: 6px;"> PO Generated</span></a><?php if($resListingIndent1['isCancel']=='yes'){ ?><br><br><span class="badge" style="cursor:pointer;background-color:red; color:#fff; position: relative;width: 142px; font-size: 11px; padding: 6px;"> Canceled</span> <?php } } ?></td>
				</tr>
				<?php  } } ?>
				</tbody>
				</table>
...
?>
                <table width="100%" class="table table-bordered upper-1-table" style="">
                  <tr>
