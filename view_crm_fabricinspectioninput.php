...
$lastId = decode($_GET['styleid']);
$styleId = decode($_GET['styleid']);
$newTotal=0;
$rsqty=GetPageRecord('sum(materialQty) as totalFabricQuantiy,orderQty','indentCreationMaster','requisitionNo="'.decode($_REQUEST['requisitionNo']).'" and materialTypeId=1');
$resultqty=mysqli_fetch_array($rsqty);
$totalstylequantity=$resultqty['totalFabricQuantiy'];
$newTotal = $totalstylequantity;
if($newTotal==$resultqty['totalFabricQuantiy']){
...
$rsgrnMee=GetPageRecord('materialUniqueId,id','materialMaster','name="'.$rsgrnMName['name'].'"');
...
?>
                     ...
                     <input type="hidden" name="spo" id="spo" value="<?php echo $_REQUEST['spo']; ?>" />
                      ...
                      <input type="hidden" name="materialMasterId" id="materialid" value="<?php echo $rsgrnMNameee['id']; ?>" />
                          ...
                          <td style="width:33%;"><table class="table table-bordered table-responsive lotsummary" style=" overflow:hidden !important;">
                              <tbody style="width: 100%;display: inline-table;">
                                ...
                                <tr class="card-body">
                                  ...
                                  <td><div align="center">
                                      <input type="text" name="recievedqtyforthislot" id="recievedqtyforthislot" value="<?php echo $rsgrnSupplierName['totalReceived']; ?>" readonly >
                                    </div></td>
                                </tr>
                                <tr class="card-body">
                                  <td width="56%">Total received till now</td>
                                  <td width="44%"><div align="center">
                                      <input type="text" name="totalreceivedtillnow" id="totalreceivedtillnow" value="<?php echo $rsgrnSupplierName['netReceived']; ?>" readonly >
                                    </div></td>
                                </tr>
                                <tr class="card-body">
                                  <td>Balance </td>
                                  <td><div align="center">
                                      <input type="text" name="balancelot" id="balancelot" readonly value="<?php echo $rsgrnSupplierName['orderQty']-$rsgrnSupplierName['netReceived']; ?>">
                                    </div></td>
                                </tr>
                                <tr class="card-body">
                    ...
                    <table width="100%" class="table table-bordered table-responsive input-table" style="font-size:11px !important;">
                      <tr height="61" style="padding: 10px; font-weight: 600; background-color: #F8F8F8; margin-top: 10px; position: relative;">
                        ...
                        <td colspan="2" align="center"><div align="center">Meterage</div></td>
                         ...
                         <td colspan="2" align="center"><div align="center">GSM</div></td>
                      ...
                      <tr height="48" style="padding: 10px; font-size: 11px; font-weight: 600; background-color: #F8F8F8; margin-top: 10px; position: relative;">
                        ...
                        <td width="38" height="48"><div align="center">Before Wash</div></td>
                        <td width="34"><div align="center">After Wash</div></td>
...
padding: 5px !important;
                  ...
                  <div class="col-md-12" style="margin-bottom:20px;">
                    <?php
$whe = '1 and styleId="'.$styleId.'" and lotNoMaster="'.decode($_REQUEST['lotId']).'"';
$k=GetPageRecord('*','qualitymodulemaster',$whe);
$lotData=mysqli_fetch_array($k);
...
$lotResultq=GetPageRecord('*','lotWiseData','1 and styleId="'.$styleId.'" and lotId="'.$lotData['lotNoMaster'].'"');
$lotResult=mysqli_fetch_array($lotResultq);

$rsSupplier=GetPageRecord('supplierId','indentCreationMaster','requisitionNo="'.decode($_GET['requisitionNo']).'" and materialId="'.decode($_GET['materialid']).'"');
$rsSupplierName=mysqli_fetch_array($rsSupplier);
...
$rsgrnSupplier=GetPageRecord('sum(received) as totalReceived,orderQty,netReceived','grnMaster','requisitionNo="'.decode($_GET['requisitionNo']).'" and parentId="'.decode($_GET['grnid']).'" and materialId="'.decode($_GET['materialid']).'"');
$rsgrnSupplierName=mysqli_fetch_array($rsgrnSupplier);
...
$rsgrnMee=GetPageRecord('materialUniqueId','materialMaster','id="'.$rsgrnSupplierName['materialId'].'"');
$rsgrnMNameee=mysqli_fetch_array($rsgrnMee);
...
?>
                    ...
                    <form action="ac.crm" method="post" enctype="multipart/form-data" name="popidfirst<?php echo $lotNameData['id']; ?>" target="acf" id="popidfirst<?php echo $lotNameData['id']; ?>">
					  ...
					  <input type="hidden" name="colorid" id="colorid" value="<?php echo $_REQUEST['colorid']; ?>" />
                      <input type="hidden" name="action" id="action" value="savelotdata" />
                      <input type="hidden" name="fabricType" id="fabricType" value="<?php echo $_REQUEST['fabricType']; ?>" />
                      <input type="hidden" name="lotIdupper" id="lotIdupper" value="<?php echo encode($lotData['lotNoMaster']); ?>" />
                      <input type="hidden" name="styleId" id="styleId" value="<?php echo encode($lastId); ?>" />
                      <input type="hidden" name="editId" id="editId" value="<?php echo encode($lotResult['id']); ?>" />
					  <input type="hidden" name="greigeOrderQty" value="<?php echo $rsgrnSupplierName['orderQty']; ?>" />
                      <table class="inspection-report" style="font-size:12px !important; width:100%;">
                        <tr>
                          <td colspan="3" style="padding: 10px !important; text-align: left; font-size: 16px; cursor: pointer; background-color: #e5fbfa; position: relative; font-weight: 500; color: #000000; width: 100%; box-sizing: border-box; border:1px solid #ccc;"><?php echo $lotNameData['name']; ?></td>
                        </tr>
			...
			?>
                        ...
                        <tr>
                          <td style="width:33%;padding-left: 0px !important;"><table class="table table-bordered table-responsive lotsummary" style=" overflow:hidden !important;">
                              <tbody style="width: 100%;display: inline-table;">
                                ...
                                <tr class="card-body">
                                  <td width="56%">Lot Receiving Date</td>
                                  <td width="44%" colspan="2"><div align="center">
                                      <input type="text" style="background-color: #eee;" name="lotRecievedDate" id="lotRecievedDate" value="<?php if($grnData['prepareDate']!="" && $grnData['prepareDate']!="0000-00-00" && $grnData['prepareDate']!="1970-01-01"){ echo date('d-m-Y',strtotime($grnData['prepareDate'])); } ?>" class="newDatePicker" readonly />
                                    </div></td>
                                </tr>
                                <tr class="card-body">
                                  <td width="56%">Total Fabric order qty</td>
                                  <td width="44%" colspan="2"><div align="center">
                                      <input type="text" style="background-color: #eee;" name="lotfabricorderQty" id="lotfabricorderQty" value="<?php echo $rsgrnSupplierName['orderQty']; ?>" readonly />
                                    </div></td>
                                </tr>
                                <tr class="card-body">
                                  <td>Received qty - for this lot</td>
                                  <td colspan="2"><div align="center">
                                      <input type="text" style="background-color: #eee;" name="recievedqtyforthislot" id="recievedqtyforthislot" value="<?php echo $rsgrnSupplierName['totalReceived']; ?>" readonly >
                                    </div></td>
                                </tr>
                                <!-- <tr class="card-body">
                                  <td width="56%">Total received till now</td>
                                  <td width="44%"><div align="center">
                                      <input type="text" style="background-color: #eee;" name="totalreceivedtillnow" id="totalreceivedtillnow" value="<?php echo $rsgrnSupplierName['netReceived']; ?>" readonly >
                                    </div></td>
                                </tr> -->
                                <tr class="card-body">
                                  <td><div align="left">Accepted</div></td>
				...
				function addNewRow(id){
				if(id==1){
				$("#addrow").load('loadqualitydata.php?add=1&styleId=<?php echo encode($lastId); ?>&costsheetVersionId=1&lotId=<?php echo decode($_REQUEST['lotId']); ?>&fabricType=<?php echo $_GET['fabricType']; ?>');
				}else{
				$("#addrow").load('loadqualitydata.php?styleId=<?php echo encode($lastId); ?>&lotId=<?php echo decode($_REQUEST['lotId']); ?>&fabricType=<?php echo $_GET['fabricType']; ?>');
				}
				...
				var checkyes = confirm('Are your sure you you want to delete?');
				if(checkyes==true){
				$('#addrow').load('loadqualitydata.php?id='+id+'&deletestatus=yes&styleId=<?php echo encode($lastId); ?>&lotId=<?php echo decode($_REQUEST['lotId']); ?>&fabricType=<?php echo $_GET['fabricType']; ?>');
				}
				}
				</script>
                    </table>
