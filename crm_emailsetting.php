		...
		<div class="content-wrapper">
			...
			<div class="content pt-0" style="margin-top:20px;">
				...
				<?php include "left-setting.php"; ?>
					...
					<div class="col-xl-10 emailsettingdropdown">
										...
										<ul class="list-inline list-inline-condensed mb-0 mt-2 mt-sm-0">
											...
											<li class="list-inline-item dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<?php if($rest['id']!='1'){ ?>
													<a onclick="deleteItem('<?php echo encode($rest['id']); ?>');" class="dropdown-item"><i class="fa fa-trash" aria-hidden="true"></i> Delete This Email</a>
													<?php } ?>
													<script>
														function deleteItem(did) {
														alert(did);
														if (confirm('Are you sure you want to delete this email setting?')) {
														//window.location.href = "showpage.crm?action=deleteuseremail&did="+did;
