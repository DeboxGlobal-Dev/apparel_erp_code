			 ...
			 <div style="width:100% ;display:block;">
				...
				<table class="table table-responsive wip2" style="width:100%;">
					...
					<tr style="background-color:#f5f5f5;color: #000;" align="center">
						<?php
						$rsDepartment=GetPageRecord('id,name','departmentMaster','1 and id in (41,52,17) order by field(id, 41,52,17)');
				...
				<!-- <table class="table wip1" style="width:100%;">
					...
					<tr style="background-color:#ffffcc;color: #000;">
						<th colspan="" align="left" >GRN No.</th>
						<td colspan="" align="left" >PO Number</td>
						<td colspan="" align="left" >Bill Comparision (Standard vs Actual)</td>
					</tr>
					<tr>
						<td colspan="" align="left" >zcsds</td>
						<td colspan="" align="left" >sdfds</td>
						<td colspan="" align="left" >sdsdfsd)</td>
					</tr>
				</table> -->
				</div>
			</div>
