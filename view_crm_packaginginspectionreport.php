		 	...
		 	<div class="content pt-0" style="margin-top:20px; overflow:hidden;">
				...
				<div class="card">
							<div class="card-header bg-white">
								<h6 class="card-title">Packaging Inspection Report </h6>
...
<?php
$rl=GetPageRecord('*','packagingqualityreportmaster',' styleId="'.decode($_REQUEST['styleid']).'" and type="packagingtriminspectioninput" and lotId="'.decode($_REQUEST['lotId']).'"');
