...
addlistinggetlastid('accessoriesArtwork',$namevalueadd);
}

if($_REQUEST['deletestatus']=="yes" && $_REQUEST['id']!=''){
deleteRecord('accessoriesArtwork','id="'.$_REQUEST['id'].'"');
}
...
$rs=GetPageRecord($select,'accessoriesArtwork',$where);
...
<tr class="border-top-info">
    <td align="center"><i class="fa fa-trash" style="font-size: 20px; color:#FF0000;" onClick="deleteAccessrory('<?php echo $resListing1['id']; ?>');"></i></td>
	<td><?php echo $sNo2; ?></td>
