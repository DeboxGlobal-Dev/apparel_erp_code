			...
			<div class="content">
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					...
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-1" style="cursor:pointer;"  <?php if($_REQUEST['id']!=''){ ?> onclick="view('<?php echo $_REQUEST['id']; ?>');" <?php } else { ?> onclick="cancel();"<?php  } ?> ></i> 	<?php if($_REQUEST['id']!=''){ echo 'Edit'; } else { echo 'Add'; } ?> Account</h4>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label>Type</label>
											   <select name="bussinessType" class="form-control select select2-hidden-accessible" id="bussinessType" tabindex="-1" data-fouc="" aria-hidden="true">
												<option value="1" <?php if(1==$bussinessType){ ?>selected="selected"<?php } ?>>Corporate</option>
												<option value="2" <?php if(2==$bussinessType){ ?>selected="selected"<?php } ?>>Agent</option>
												</select>
			                                </div>
										</div>
										<div class="col-md-6">
...
<?php } ?>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input name="attachment" type="file" class="form-control" id="attachment" aria-invalid="false"  >
												<input name="oldAtachment" id="oldAtachment" type="hidden" value="<?php echo $editattachment; ?>" />
			                                </div>
										</div>
									</div>
						    </div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
				                                ...
				                                <input name="loginUserName" type="text" class="form-control validate" id="loginUserName" value="<?php echo $editloginUserName; ?>" maxlength="100"  aria-invalid="false"  >
			                                </div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Password </label>
				                                <input name="loginPassword" type="password" class="form-control" id="loginPassword" value="" maxlength="50"   aria-invalid="false"><input name="oldLoginPassword" type="hidden" value="<?php echo $editloginPassword; ?>" />
			                                </div>
										</div>
									</div>
						    </div>
...
<div class="text-right">
					...
					Enter your Account's company name  and hint will search for additional data.			    </div>
					</div>
				</div>
