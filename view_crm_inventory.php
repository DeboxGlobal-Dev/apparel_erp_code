...
<div class="card-body listc">
  <table class="table table-bordered table-responsive">
      <thead style="background: #00b5ea; font-weight: 700; color: #ffff;">
          <tr>
              <td colspan="25"><?php echo $matListData['name']; ?> -
                  <?php echo 'Style '.'#'.$styleData['styleRefId']; ?></td>
          </tr>
      </thead>
      <thead>
          <tr class="border-top-info">
              ...
              <th>Placement</th>
              <th>
                  <div style="width: 145px;">Supplier</div>
              </th>
              <th>Material&nbsp;Id</th>
              <th>Avg.</th>
              <th>PO&nbsp;Qty (Excess)</th>
              ...
              <th style="text-align:center;">TR&nbsp;No&nbsp;-&nbsp;From&nbsp;Style</th>
...
?>
      <tbody id="myTable">
          <tr class="border-top-info">
              <td>
                  <div align="center"><?php echo $sr.'//'.$id; ?></div>
              </td>
              <td><?php if($query_styles['sampleStyle']==2){  echo $query_styles['sample_indent']; } else{ echo $resultqty['indentNumber']; }?>
              </td>
...
?>
              ...
              <td>
                  <div style="width:145px">
                      <?php echo getsupplierCompany($techShellData['storesupplier']); ?></div>
              </td>
              ...
              <td><?php echo round($rsgrnrecTill['netReceivedTill'],2); ?></td>
              <td><?php  if($styleData['sampleStyle']=='1'){ echo "Bulk"; }else{ echo "Sample"; } ?>
              </td>
              <td><?php
...
?>
              ...
              <td><?php if($query_styles['sampleStyle']==2){ echo round($rsgrnrecTill['netReceivedTill'],2); }else {if($inspectedQty!=''){ echo $inspectedQty; }else{ echo '-'; } } ?>
              </td>
              <td></td>
              <td>
                  <?php
...
?>
              ...
              <td><?php echo $totalissuetilldate+$rsExtSum['totalexport']; ?></td>
              <td>
                  <?php
...
?>
                  <?php if($query_styles['sampleStyle']==2){ echo round($rsgrnrecTill['netReceivedTill'],2)- $totalissuetilldate;}else { echo $inspectedQty - $totalissuetilldate-$rsExtSum['totalexport']; } ?>
              </td>
              <td><?php
$c=0;
...
?>
          <tr>
              ...
              <td>
                  <?php //echo $rsReqData['excess_qty_cut']*$rsReqData['greigeAvg']; ?>
                  <?php
...
<?php echo $finalAllQty; ?>
              </td>
              <td></td>
              <td><?php //echo $rsgrndatalistGrQ['received']; ?><?php echo $finalAllQty; ?></td>
              <td>Bulk</td>
              <td><?php
