...
<div class="page-content">
  ...
  <div class="content-wrapper">
	...
	<?php if($editresult1['sectionType']!='greigerequisition'){ ?>
            ...
            <div style="padding: 20px;">
              <table class="table erptab table-hover" style="width:100%">
				...
				<tr >
					...
					<!----Sales order change---->
					<?php if($editresult1['sectionType']=='' || $editresult1['sectionType']=='greigerequisition'){ ?>
					...
					<?php } ?>
					<?php if($rsamdList['finalQtyOld']!=$rsamdList['finalQty']){ ?>
					<td><?php echo $rsamdList['finalQtyOld']; ?></td>
					<td><?php echo $rsamdList['finalQty']; ?></td>
					<?php } ?>
					<?php } ?>
...
?>
			  <table class="table erptab table-hover" style="width:100%">
                <tr style=" font-weight:700;">
					<?php if($editresult1['sectionType']!='greigerequisition'){ ?><td>FOB Price</td>
					<td>Revised FOB Price</td><?php } ?>
					<td>Requested Date</td>
					<td>Approve Date</td>
				</tr>
				<tr style="">
						<?php if($editresult1['sectionType']!='greigerequisition'){ ?><td><input type="text" name="fobPrice" id="fobPrice" value="<?php echo $resListing31['fobpricenew']; ?>" class="form-control" readonly/></td>
					<td><input type="text" name="newFobPrice" id="newFobPrice" value="<?php echo $rsamdList['newFobPrice']; ?>" class="form-control" /></td><?php } ?>
			  ...
			  <p>&nbsp;</p>
              <table cellspacing="0" cellpadding="8" border="1" style="border:1px solid #ccc; <?php if($editresult1['sectionType']=='greigerequisition'){ ?>display:none;<?php } ?>">
