		...
		<div class="row">
			<div class="col-xl-12">
				<div class="card-header header-elements-inline bg-blue-700" style="padding: 10px;">
					<div class="col-xl-12"><h5 class="card-title"><?php echo $pageName; ?></h5>
					</div>
...
<?php
$cq=GetPageRecord('*','companyMaster','1 order by name asc');
while($comData=mysqli_fetch_array($cq)){ ?>
<option value="<?php echo encode($comData['id']); ?>" <?php if($_GET['companyId']==encode($comData['id'])){ ?> selected="selected" <?php } ?>><?php echo $comData['name']; ?></option>
<?php } ?>
</select>
</div>
</div>
				...
				<div style="width: 60px; margin-right: 10px;">
					<div class="">
								...
								<a class="btn bg-primary-400" href="<?php echo $fullurl; ?>tcpdf/examples/generatecoaprint.php?pageurl=<?php echo $fullurl; ?>coaprint.php?c=<?php echo $_GET['companyId']; ?>" target="_blank"><i class="fa fa-print" aria-hidden="true" style="margin-right:5px;"></i>Print</a>
							<?php } ?>
