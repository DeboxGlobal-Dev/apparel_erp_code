  ...
  $(function () {
    ...
    $('#calendar').fullCalendar({
	  ...
	  events    : [
		...
		$rs=GetPageRecord($select,'bookWashingMaster',$where);
...
$(document).on('click',function(e) {
 ...
 if (typeof $this.attr('data-date') === "undefined") {} else {
    var mid= $this.attr('data-date');
     opmodalpop('Book Washing','modalpop.php?action=bookWashingMaster&adddate='+mid+'','600px','auto');
	 }
});

function clicknew(id){
opmodalpop('Book Washing','modalpop.php?action=bookWashingMaster&id='+id+'','600px','auto');
}
