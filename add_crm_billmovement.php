                          ...
                          <td>
                              <table width="100%" border="1" cellpadding="10" cellspacing="0" bordercolor="#000000" class="">
                                <tr style="color:#FFFFFF;">
									...
									<td bgcolor="#333333" align="center"><strong>Due&nbsp;Date</strong></td>
                                </tr>
								...
								function addnewline(did){
									...
									var grnNo = $('#grnNo').val();
									$('#loadtabledata').load('loadbillmovement.php?action=addnewrow&addsize='+did+'&id='+lastid+'&grnNo='+grnNo);
								}
								<?php if($_GET['id']!=''){ ?>
								addnewline(0);
								<?php } ?>
								...
								function deleterow(deleteid){
									$('#loadtabledata').load('loadbillmovement.php?deletestatus=yes&id=<?php echo encode($grnLastId); ?>&rowid='+deleteid);
								}
								</script>
