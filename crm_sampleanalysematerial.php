...
$where='where '.$wheresearchassign.' subject!="" '.$stylerefCondition.' and sampleStyle="2" and deletestatus=0 order by id desc';
$page=$_GET['page'];
...
?>
                      <tr role="row" class="odd">
                        <td><a href="showpage.crm?module=SampleAnalyseMaterial&add=yes&styleid=<?php echo encode($resultlists['id']); ?>"><?php echo '#'.$resultlists['styleRefId']; ?>
